...
df = pd.read_csv('/Volumes/CAS9/Aeiwz/Project/KOI_CC/Code/dataset_3.csv')
#Drop QC samples
...
#line 3
if list_label[2] == 'Off pump CABG (OPCAB)':
    colour3 = '#E91E63'
elif list_label[2] == 'On pump CABG (ONCAB)':
    colour3 = '#FF9800'
elif list_label[2] == 'custodiol':
    colour3 = '#FFEB3B'
elif list_label[2] == 'del Nido':
    colour3 = '#9C27B0'
elif list_label[2] == 'st. thomas':
    colour3 = '#03A9F4'
elif list_label[2] == 'No med':
    colour3 = '#4CAF50'
    
    
#line 4
if list_label[3] == 'Off pump CABG (OPCAB)':
    colour4 = '#E91E63'
elif list_label[3] == 'On pump CABG (ONCAB)':
    colour4 = '#FF9800'
elif list_label[3] == 'custodiol':
    colour4 = '#FFEB3B'
elif list_label[3] == 'del Nido':
    colour4 = '#9C27B0'
elif list_label[3] == 'st. thomas':
    colour4 = '#03A9F4'
elif list_label[3] == 'No med':
    colour4 = '#4CAF50'
...
# create a new trace for the connecting line
fig.add_trace(go.Scatter(
    x=med_df.loc[10:14, "PC1"], # x-coordinates of the line
    y=med_df.loc[10:14, "PC2"], # y-coordinates of the line
    mode='lines', # specify the trace type as lines
...
# create a new trace for the connecting line
fig.add_trace(go.Scatter(
    x=med_df.loc[15:19, "PC1"], # x-coordinates of the line
    y=med_df.loc[15:19, "PC2"], # y-coordinates of the line
    mode='lines', # specify the trace type as lines
    line=dict(color=colour4, width=2), # set the color and width of the line
    showlegend=False # hide the trace from the legend
))
